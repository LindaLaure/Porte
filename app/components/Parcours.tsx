...
const Parcours: React.FC = () => {
  return (
    ...
    <h3 className={styles.Heading2}> Master 2 Pro. (CIM) Gestion de projects et Conception Multimédia </h3>
        <p className = {styles.description}> Université Lumière Lyon II, France </p>
        <p className = {styles.description}> Septembre 2021 - Décemebre 2020 </p>
                    <ul className = {styles.items}>
          <li>Gestion de projects informatiques</li>
          <li>Multimédia et communication ( réalisation de films, Modélisation 3D et Animation)</li>
          <li>Technologie de l'internet (XML, Web dynamique, CMS, et Big Data)</li>
          <li>Conception des projects informatiques</li>
          </ul>
      <h3 className={styles.Heading2}> Master 1 Pro. (SIGL) Système d'Information et Génie Logiciel </h3>
      <p className = {styles.description}> Université de Yaoundé 1, Cameroun </p>
      ...
      <ul className = {styles.items}>
        ...
        <li> Réseaux et programmation (Java EE, UML, SQL, NoSQL,Web, CMS) </li>
      </ul>
 <h3 className={styles.Heading2}> Diplome d'Ingénieur des réseaux et Télécommunication </h3>
    ...
    <ul className = {styles.items}>
      ...
      <li> Peogrammation (JAVA, C, PHP, HTML)</li>
        ...
        <p className={styles.titre}> Loisir</p>
          ...
          <ul className = {styles.items}>
            <li>Animation : Organisatrice des événements de divertissements liés aux animés</li>
            <li>Chant : Participation au 60ème festival coréen K-Pop World </li>
            <li>Lecture : Livres de développement personnel, bande dessinées et romans </li>
        ...
        <ul className={styles.items}>
    <li> Cheffe de Project | Reverie 237| Toulouse</li>
    <li></li>
        </ul>
      </div>
    </>
